# Launching `timesfm-mcp`: Give your AI Agents Time-Series Forecasting Superpowers
...
Today, we're releasing **`timesfm-mcp`**, an open-source MCP server that gives agents native access to robust forecasting.
...
* **Google's TimesFM 2.5 Support**: If you need the heavy-hitting foundation model, `timesfm-mcp` lazily loads and wraps Google's new 200M parameter TimesFM 2.5 model. Your agents can automatically predict massive series natively.
...
Check out the repo here: [https://github.com/ramdhavepreetam/timesfm-mcp](https://github.com/ramdhavepreetam/timesfm-mcp)
